...
<!-- ⚡ NEW: Added the id="room-header-wrapper" here! -->
<div id="room-header-wrapper" class="flex justify-between items-center">
    ...
    <div class="flex items-center space-x-4">
        ...
        @if($room->streak_count > 0)
            <div class="px-3 py-1 bg-orange-100 border border-orange-300 text-orange-700 font-bold rounded-full text-sm flex items-center shadow-sm animate-fade-in">
                🔥 {{ $room->streak_count }} Day Streak
            </div>
        @else
            <div class="px-3 py-1 bg-gray-100 text-gray-500 font-medium rounded-full text-sm flex items-center animate-fade-in">
                🧊 No active streak
            </div>
        @endif
